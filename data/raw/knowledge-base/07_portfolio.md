...
Este documento apresenta o portfólio profissional de **Tatiane Souza**, reunindo projetos, aplicações desenvolvidas, experiências práticas e canais on-line onde sua trajetória tecnológica pode ser acompanhada.

O objetivo é facilitar a consulta pelo **Sowza Career Assistant** sobre projetos publicados, demonstrações técnicas e presença profissional digital.
...
## Presença Profissional On-line

### GitHub

Perfil utilizado para publicação de projetos, códigos, estudos e experimentos em tecnologia.
...
Tatiane Souza, SowzaTech, Portfólio, sowza.dev, GitHub, LinkedIn, Sowza Career Assistant, Desenvolvimento Web, Front-End, Inteligência Artificial, RAG, Tecnologia, Cloud Computing, Engenharia de Software
